...
from app.ml import history, storage
...
def isolate(tmp_path, monkeypatch):
    ...
    # app.api грузит модель при импорте — сбрасываем, чтобы «модель не обучена» было честным
    monkeypatch.setattr(api, "model_state", None)
